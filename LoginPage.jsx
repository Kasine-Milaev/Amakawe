...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Сохраняем email в localStorage если выбрано "Запомнить меня"
      if (rememberMe) {
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      return setError('Введите email для восстановления пароля');
    }
  ...
  // Загружаем сохраненный email при загрузке
  React.useEffect(() => {
